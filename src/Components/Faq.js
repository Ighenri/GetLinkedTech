...
function Faq() {
  return (
    <section id='faq' className="container flex flex-col md:flex-row justify-evenly items-center min-h-screen text-white mx-auto w-[90%] border-b-2 border-gray-800">
