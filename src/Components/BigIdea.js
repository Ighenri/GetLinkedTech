...
function BigIdea() {
  return (
    <section id='overview' className="container flex flex-col md:flex-row justify-evenly items-center mt-60 md:mt-0 lg:mt-0 h-screen text-white mx-auto w-[90%] border-b-2 border-gray-800">
