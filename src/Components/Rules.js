...
function Rules() {
  return (
    <section className="container flex flex-col md:flex-row justify-between items-center mt-80 lg:mt-20 min-h-screen text-white mx-auto w-[90%] ">
      ...
      <div className="writeup w-[80%]  mx-auto md:w-1/2">
        ...
        <h5 className=" text-purple font-bold">tech Hackatheon 1.0</h5>
        <p>
